...
Для всіх програм обов'язковим є використання прапорця `-Wall` (виведення всіх попереджень компілятора):
```bash
gcc -Wall <назва_файлу.c> -o <назва_програми>
